...
const Tools = () => {
  ...
  const tools = [
    ...
    {
      icon: Zap,
      name: "Thrust Loading Calculator",
      description: "Calculate thrust-to-weight ratio (T/W) with mission-specific classification and engineering interpretations for aircraft design.",
