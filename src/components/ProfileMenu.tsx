  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="relative w-10 h-10 rounded-full bg-primary/20 border-2 border-primary flex items-center justify-center hover:bg-primary/30 transition-colors"
        style={{
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="absolute right-0 mt-2 w-64 bg-card border border-primary/20 rounded-lg shadow-lg overflow-hidden z-50"
              style={{
              ...
              <div className="py-2">
                {menuItems.map((item) => (
                  <Link
                    ...
                    to={item.href}
                    onClick={() => setIsOpen(false)}
                    className="flex items-center gap-3 px-4 py-2 hover:bg-primary/10 transition-colors text-foreground"
                  >
