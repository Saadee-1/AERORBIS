...
const Hero = () => {
  ...
  return <section id="home" className={`relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-hero pt-20 transition-all duration-500 ${isActive ? "shadow-[inset_0_0_100px_rgba(34,211,238,0.4)] border-t-4 border-b-4 border-cyan-400/50" : ""}`}>
      ...
      <div className="absolute inset-0 z-0">
        {[...Array(50)].map((_, i) => <motion.div key={i} className="absolute w-1 h-1 bg-secondary rounded-full" style={{
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          delay: 0.6
            ...
            <Button size="lg" variant="outline" className="border-2 border-secondary text-secondary hover:bg-secondary hover:text-secondary-foreground text-lg px-8 py-6 group">
