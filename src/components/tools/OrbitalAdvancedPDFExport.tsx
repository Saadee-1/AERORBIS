...
interface AdvancedPDFExportProps {
  ...
  monteCarloResults?: AdvancedResult[];
...
<body>
  <div class="header">
    ...
    <p class="metadata">AERORBIS Engineering Tools — Homework Submission Report</p>
  </div>
  ...
  <div class="footer">
    <p>Generated by AERORBIS Engineering Tools</p>
