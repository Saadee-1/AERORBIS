      ...
      <AeroCard title="Lift Curve Slopes">
        <div className="grid grid-cols-2 gap-4">
          <div className="p-4 bg-muted/30 rounded-lg border border-border">
            <p className="text-xs text-muted-foreground mb-1">Wing (a_w)</p>
            <p className="text-foreground font-bold text-lg">
              {safeToFixed(results.a_w, 3)} /rad
            </p>
          </div>
          <div className="p-4 bg-muted/30 rounded-lg border border-border">
            <p className="text-xs text-muted-foreground mb-1">Tail (a_t)</p>
            <p className="text-foreground font-bold text-lg">
      ...
      <AeroCard title="Longitudinal Stability">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          ...
          <div className="p-4 bg-gradient-to-br from-purple-400/10 to-pink-400/10 rounded-lg border border-purple-400/20">
            <p className="text-xs text-muted-foreground mb-1">Neutral Point</p>
          ...
          <div className="p-4 bg-gradient-to-br from-green-400/10 to-emerald-400/10 rounded-lg border border-green-400/20">
            <p className="text-xs text-muted-foreground mb-1">Static Margin</p>
          ...
          <div className="p-4 bg-gradient-to-br from-orange-400/10 to-red-400/10 rounded-lg border border-orange-400/20">
            <p className="text-xs text-muted-foreground mb-1">Tail Volume</p>
        ...
        <AeroCard title="Control Derivatives">
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            {results.C_m_delta_e !== undefined && (
              <div className="p-4 bg-muted/30 rounded-lg border border-border">
                <p className="text-xs text-muted-foreground mb-1">C_mδe</p>
                <p className="text-foreground font-bold text-lg">
                  {safeToFixed(results.C_m_delta_e, 4)}
                </p>
                <p className="text-xs text-muted-foreground/70 mt-1">Elevator</p>
              </div>
            )}
            {results.C_l_delta_a !== undefined && (
              <div className="p-4 bg-muted/30 rounded-lg border border-border">
                <p className="text-xs text-muted-foreground mb-1">C_lδa</p>
                <p className="text-foreground font-bold text-lg">
                  {safeToFixed(results.C_l_delta_a, 4)}
                </p>
                <p className="text-xs text-muted-foreground/70 mt-1">Aileron</p>
              </div>
            )}
            {results.C_n_delta_r !== undefined && (
              <div className="p-4 bg-muted/30 rounded-lg border border-border">
                <p className="text-xs text-muted-foreground mb-1">C_nδr</p>
                <p className="text-foreground font-bold text-lg">
                  {safeToFixed(results.C_n_delta_r, 4)}
                </p>
                <p className="text-xs text-muted-foreground/70 mt-1">Rudder</p>
              </div>
            )}
          </div>
        </AeroCard>
        ...
        <AeroCard title="Lateral/Directional Derivatives">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {results.C_l_beta !== undefined && (
              <div className="p-4 bg-muted/30 rounded-lg border border-border">
                <p className="text-xs text-muted-foreground mb-1">C_lβ</p>
                <p className="text-foreground font-bold text-lg">
            ...
            {results.C_n_beta !== undefined && (
              <div className="p-4 bg-muted/30 rounded-lg border border-border">
                <p className="text-xs text-muted-foreground mb-1">C_nβ</p>
                <p className="text-foreground font-bold text-lg">
            ...
            <div className="p-4 bg-muted/30 rounded-lg border border-border">
              <p className="text-xs text-muted-foreground mb-1">C_lp</p>
              <p className="text-foreground font-bold text-lg">
                {safeToFixed(results.C_l_p, 4)}
              </p>
            </div>
            <div className="p-4 bg-muted/30 rounded-lg border border-border">
              <p className="text-xs text-muted-foreground mb-1">C_nr</p>
              <p className="text-foreground font-bold text-lg">
