...
export const AIRCRAFT_PRESETS: Record<string, AircraftPreset> = {
  ...
  'custom': {
    ...
    description: 'Start with default values and customize all parameters',
    category: 'Custom',
    S_w: 15.0,
    AR: 7.0,
    c_bar: 1.5,
    ...
    x_cg_min: 0.20,
    x_cg_max: 0.30,
    notes: 'Default template - edit all parameters in the Geometry, Aerodynamics, and Controls tabs',
  },
};
